...
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
$route['login']='Membership/login';
$route['register']='Membership/register';
$route['getGroups']='GroupsController/getGroups';
$route['createGroup']='GroupsController/createGroup';
$route['deleteGroup']='GroupsController/deleteGroup';
$route['getExpenses']='ExpenseController/getExpenses';
$route['AddExpense']='ExpenseController/AddExpense';
$route['deleteExpense']='ExpenseController/deleteExpense';
$route['getMembers']='ExpenseController/getMembers';
$route['SearchMember']='ExpenseController/SearchMember';
$route['addMember']='ExpenseController/addMember';
$route['UpdateGroupInfo']='ExpenseController/UpdateGroupInfo';
$route['getGroupInfo']='ExpenseController/getGroupInfo';
